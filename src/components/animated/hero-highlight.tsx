...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[43rem] w-full items-center justify-center bg-background/50 backdrop-blur-md",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-secondary px-1 pb-1 dark:from-indigo-500 `,
        className,
      )}
    >
      {children}
